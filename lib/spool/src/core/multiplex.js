...
export const pattern_match = (acc, C, out$ = { next: null }, i = null) => __awaiter(void 0, void 0, void 0, function* () {
    if (acc === null)
        return null;
    ...
    const { args_type, args } = yield process_args(acc, _args);
    ...
    let result = new EquivMap([
        [{ K_M, args_type: "UNKNOWN" }, () => (console.warn(NA_keys(C)))]
    ]), [{ K_M, args_type: , "OBJECT":  },];
    () => __A;
